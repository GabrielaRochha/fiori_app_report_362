		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Fiori Report",
									"targetURL": "#brcomgestaofioriappreport362-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"brcomgestaofioriappreport362-display": {
								"semanticObject": "brcomgestaofioriappreport362",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=br.com.gestao.fioriappreport362",
									"url": sap.ui.require.toUrl("br/com/gestao/fioriappreport362")
								}
							}
						}
					}
